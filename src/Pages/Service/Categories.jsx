      ...
      <div className="row">
        <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          <div className="icon-box" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="description">Make your presence felt online with website development services from DevelopIQ Technologies.</p>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          <div className="icon-box" data-aos="fade-up" data-aos-delay="200">
            ...
            <p className="description">Make your web applications services from DevelopIQ Technologies</p>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          <div className="icon-box" data-aos="fade-up" data-aos-delay="300">
            ...
            <p className="description">Multiply the sales of your business with the help of an E-commerce website.</p>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          <div className="icon-box" data-aos="fade-up" data-aos-delay="400">
            ...
            <h4 className="title"><Link to="/">Maintenance</Link></h4>
